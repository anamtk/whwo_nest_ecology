model{
  ...
  ## at multiple scales
  # - SAM model for antecedent temperature variable
  ...
  for(i in 1:n.nests){
    ...
    mu[i] <- 
      ...
      b[9]*LandBu[i] +
      #interactions
      b[10]*Trees50[i]*PercPonderosa[i] +
      b[11]*Trees2550[i]*PercPonderosa[i] +
      b[12]*TmaxAnt[i]*Trees2550[i] +
      b[13]*LandHa[i]*LandBu[i]
  ...
  #ensure b1[1] has most observations
  # for(tt in 2:n.trt){
  #   b1[tt] ~ dnorm(0, 1E-2)
  # }
  # 
