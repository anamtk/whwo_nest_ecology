...
data <- readRDS("/scratch/atm234/nests_10_19/nestling_survival/inputs/nestling_JAGS_input_data.RDS")
...
# Set some initials for convergence ---------------------------------------

inits <- readRDS('/scratch/atm234/nests_10_19/nestling_survival/inputs/nestling_inits_list.RDS')

# JAGS model --------------------------------------------------------------

nestling_mod <- jagsUI::jags(data = data.list,
                            inits = inits,
                            #inits = NULL,
                            model.file = "/scratch/atm234/nests_10_19/nestling_survival/inputs/model_nestling.R",
...
saveRDS(nestling_mod, 
        file = "/scratch/atm234/nests_10_19/nestling_survival/outputs/nestling_survival_model_10_19.RDS")
