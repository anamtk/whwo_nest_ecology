...
jags <- readRDS(file = "/scratch/atm234/nests_10_19/nestling_survival/outputs/nestling_survival_model_10_19.RDS")
...
saveRDS(jags.update, 
        file= "/scratch/atm234/nests_10_19/nestling_survival/outputs/nestling_survival_model_GOF_10_19.RDS")
...
saveRDS(samples_all2, 
        file= "/scratch/atm234/nests_10_19/nestling_survival/outputs/nestling_survival_model_samples_10_19.RDS")

summary <- summary(jags$samples)

saveRDS(summary, 
        file= "/scratch/atm234/nests_10_19/nestling_survival/outputs/nestling_survival_model_summary_10_19.RDS")
